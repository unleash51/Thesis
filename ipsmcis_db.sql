...
--
-- Table structure for table `addingprograms`
--

CREATE TABLE `addingprograms` (
  `ID` int(3) NOT NULL,
  `Program` varchar(50) NOT NULL,
  `Country` varchar(20) NOT NULL,
  `School` varchar(50) NOT NULL,
  `Tuition` int(15) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `addingprograms`
--

INSERT INTO `addingprograms` (`ID`, `Program`, `Country`, `School`, `Tuition`) VALUES
(6, 'Welder', 'Australia', 'University of Sydney', 180000),
(8, 'Hotel and Restaurant Management', 'Cambodia', 'Northbridge International School Cambodia', 150000);

-- --------------------------------------------------------

--
-- Table structure for table `addingschool`
--

CREATE TABLE `addingschool` (
  `ID` int(11) NOT NULL,
  `School` varchar(50) NOT NULL,
...
--
-- Dumping data for table `addingschool`
--

INSERT INTO `addingschool` (`ID`, `School`, `Address`, `Country`, `Contact`) VALUES
(3, 'University of Recoletos', 'Gatuslao Street. Bacolod City', 'Philippines', 9072717398),
(4, 'University of Sydney', 'Australia, Sydney', 'Australia', 90087876876);
...
(1, 'Post Graduate Diploma in Mentoring and Professional Leadership', 204, '1169940', 'Post Graduate'),
(2, 'Post Graduate Diploma in Management (Business, Health, Hospitality, Information Technology)', 204, '1169940', 'Post Graduate'),
(3, 'Skills Practicum Certificate in Business Management', 205, '6770', 'Skills Practicum Certificate');
...
CREATE TABLE `tourist_matching` (
  ...
  `Spots_Address` varchar(100) NOT NULL,
...
(1, 'Sydney Opera House', 'Bennelong Point, Sydney NSW 2000', 'Landmarks', 'Australia', 0);
...
INSERT INTO `users` (`userid`, `fullname`, `username`, `email`, `password`, `usertype`, `disable`) VALUES
(2, 'Steve Tuiza', 'steve', 'steve@gmail.com', '12345', 'Client', 0),
(8, 'Renter John Aride', 'unleash51', 'renterjohnaride@gmail.com', 'razorbloodsunleash', 'Admin', 0);
...
--
-- Indexes for table `addingprograms`
--
ALTER TABLE `addingprograms`
  ADD PRIMARY KEY (`ID`);

--
-- Indexes for table `addingschool`
--
ALTER TABLE `addingschool`
  ADD PRIMARY KEY (`ID`);
...
--
-- AUTO_INCREMENT for table `addingprograms`
--
ALTER TABLE `addingprograms`
  MODIFY `ID` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `addingschool`
--
ALTER TABLE `addingschool`
